...
import static com.daria.learn.rentalhelper.rentalfetcher.DomainHelper.*;
...
public class RentalPersistenceTest {
    ...
    public void testCorrectUpdatedOffersShouldBeNotifiedAbout() {
        ...
        RentalOfferDetailsDTO detailsNotToNotifyAbout = copyRentalOfferDetailsDTOUpdated(initialDetailsOffer1, true, "Apartment 8 new", RentalStatusDTO.UNDER_OPTION, initialDetailsOffer1.getAvailableFrom(), initialDetailsOffer1.getPrice() );
