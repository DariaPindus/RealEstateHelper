...
import com.daria.learn.rentalhelper.core.communication.message.RentalNotificationSender;
import com.daria.learn.rentalhelper.core.jobs.ScheduledDetailsUpdateJob;
...
//    private FetcherFacade fetcherFacade;
    @MockBean
    private RentalOfferFacade rentalOfferFacade;
    @MockBean
    private RentalNotificationSender rentalSender;
    @MockBean
    private RentalFetchSender rentalFetchSender;
    private ScheduledDetailsUpdateJob updateJob = new ScheduledDetailsUpdateJob(rentalOfferFacade, rentalFetchSender);
    ...
    public void setup() {
        ...
        Mockito.when(rentalOfferFacade.getSourceOpenOffersUrls(any())).thenReturn(List.of());
