...
@SpringBootTest
@ActiveProfiles({BotApplicationProfiles.TEST_PROFILE, BotApplicationProfiles.WITH_MOCK_TG_BOT, BotApplicationProfiles.LOCAL_USER_REPO})
//@TestPropertySource(locations = {"classpath:inmemory-persistence.properties"})
public class RentalNotifierBotTest {
